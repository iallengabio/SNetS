...
blockingProbabilityBar <- function(directory, replicacoes, alpha, legLoads, legSol){
  ...
  bs = 6 #quantidade de colunas antes de começarem os valores de cada replicação
...
txUtilizationBar <- function(directory, replicacoes, alpha, legLoads, legSol){
  ...
  bs = 4 #quantidade de colunas antes de começarem os valores de cada replicação
  plotAuxBar(arq, metric, directory, replicacoes, alpha, legLoads, legSol, legX, legY, bs)
}
...
#Gere seus gráficos a partir daqui utilizando as funções auxiliares
directory = "D:/Documentos/Academico/Doutorado/Pesquisa/Grooming/Nova Modelagem Normalizado"
replicacoes = 10;
alpha = 0.1
