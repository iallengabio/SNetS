 ...
 * os algoritmos utilizados s�o o FirstFit na zona prim�ria e o BestFit na Zona secund�ria
 *
 * @author Iallen
 */
public class ZoneFirstBestFit implements SpectrumAssignmentAlgoritm {
    ...
    public boolean assignSpectrum(int numberOfSlots, Circuit request) {
        ...
        if (chosen == null) {//buscar na faixa secund�ria utilizando o exactFit
            ...
            //System.out.print("      merge: " + PrintTests.printFreeSpectrum(comp1) );
            chosen = BestFit.bestFit(numberOfSlots, comp1);
            //System.out.println("      escolhida: " + PrintTests.printFaixa(chosen) );
        }
