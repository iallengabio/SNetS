...
public class PowerConsumptionAwareDedicatedPathProtection_v2 implements SurvivalStrategyInterface {
            ...
            if (band != null) {
            	...
            	if(flagQoT){ //modulation has acceptable QoT
            		...
            		if(deltaSNR >= sigma){
	            		...
	            		if((chosenNumSlots == 0) || (slotsNumber < chosenNumSlots)){ //lower power consumption
			                chosenMod = mod;
			                chosenBand = band;
