...
public class BlockingProbability extends Measurement {
    ...
    public void addNewObservation(boolean success, RequestForConnection request) {
        ...
        if (!success) {
            ...
            } else if (fragmentationBlocking(request.getCircuit())) { // Check whether the cause of the block was the fragmentation
     ...
     * @return boolean
     */
    private boolean fragmentationBlocking(Circuit request) {
